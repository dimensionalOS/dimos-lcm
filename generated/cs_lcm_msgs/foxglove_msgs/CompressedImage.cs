...
namespace foxglove_msgs
{
    public sealed class CompressedImage : LCM.LCM.LCMEncodable
    {
        ...
        {
            if (classes.Contains("foxglove_msgs.CompressedImage"))
                return 0L;
 
            classes.Add("foxglove_msgs.CompressedImage");
        ...
        public static foxglove_msgs.CompressedImage _decodeRecursiveFactory(LCMDataInputStream ins)
        {
