...
{
    public sealed class JointTrajectory : LCM.LCM.LCMEncodable
    {
        public int joint_names_length;
        public int points_length;
        public std_msgs.Header header;
        public String[] joint_names;
        public trajectory_msgs.JointTrajectoryPoint[] points;
        ...
        {
            if (classes.Contains("trajectory_msgs.JointTrajectory"))
                return 0L;
 
            classes.Add("trajectory_msgs.JointTrajectory");
            ulong hash = LCM_FINGERPRINT_BASE
                 + std_msgs.Header._hashRecursive(classes)
                 + trajectory_msgs.JointTrajectoryPoint._hashRecursive(classes)
                ;
        ...
        public JointTrajectory(byte[] data) : this(new LCMDataInputStream(data))
        {
        }
 
        public JointTrajectory(LCMDataInputStream ins)
        {
        ...
        public static trajectory_msgs.JointTrajectory _decodeRecursiveFactory(LCMDataInputStream ins)
        {
            trajectory_msgs.JointTrajectory o = new trajectory_msgs.JointTrajectory();
        ...
        public void _decodeRecursive(LCMDataInputStream ins)
        {
            ...
            this.points = new trajectory_msgs.JointTrajectoryPoint[(int) points_length];
            for (int a = 0; a < this.points_length; a++) {
                this.points[a] = trajectory_msgs.JointTrajectoryPoint._decodeRecursiveFactory(ins);
            }
 
        }
 
        public trajectory_msgs.JointTrajectory Copy()
        {
            trajectory_msgs.JointTrajectory outobj = new trajectory_msgs.JointTrajectory();
            ...
            outobj.points = new trajectory_msgs.JointTrajectoryPoint[(int) points_length];
            for (int a = 0; a < this.points_length; a++) {
