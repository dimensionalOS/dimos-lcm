...
pub struct Detection3DArray {
    ...
    pub detections: Vec<crate::vision_msgs::Detection3D>,
}

impl Detection3DArray {
    pub const HASH: i64 = 0x85B4A076BA01BE3Cu64 as i64;
    pub const NAME: &str = "vision_msgs.Detection3DArray";
    ...
    pub(crate) fn hash_recursive(parents: &mut Vec<u64>) -> u64 {
        ...
        tmphash = tmphash.wrapping_add(crate::vision_msgs::Detection3D::hash_recursive(parents));
        parents.pop();
        // rotate left by 1
    ...
    pub fn encode_one<W: Write>(&self, buf: &mut W) {
        buf.write_i32::<BigEndian>(self.detections.len() as i32).unwrap();
    ...
    pub fn decode_one<R: Read>(buf: &mut R) -> io::Result<Self> {
        ...
        let detections = {
            ...
            for _ in 0..detections_length {
                let _elem_0 = crate::vision_msgs::Detection3D::decode_one(buf)?;
                v.push(_elem_0);
            }
            v
        };
