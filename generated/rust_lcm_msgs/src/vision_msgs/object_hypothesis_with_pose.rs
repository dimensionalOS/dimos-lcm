...
pub struct ObjectHypothesisWithPose {
    pub hypothesis: crate::vision_msgs::ObjectHypothesis,
    pub pose: crate::geometry_msgs::PoseWithCovariance,
}

impl ObjectHypothesisWithPose {
    pub const HASH: i64 = 0x65E1D44B451E8A8Bu64 as i64;
    pub const NAME: &str = "vision_msgs.ObjectHypothesisWithPose";
    ...
    pub(crate) fn hash_recursive(parents: &mut Vec<u64>) -> u64 {
        ...
        tmphash = tmphash.wrapping_add(crate::vision_msgs::ObjectHypothesis::hash_recursive(parents));
        tmphash = tmphash.wrapping_add(crate::geometry_msgs::PoseWithCovariance::hash_recursive(parents));
        parents.pop();
        // rotate left by 1
    ...
    pub fn encode_one<W: Write>(&self, buf: &mut W) -> io::Result<()> {
        self.hypothesis.encode_one(buf)?;
        self.pose.encode_one(buf)?;
        Ok(())
    }

    pub fn decode_one<R: Read>(buf: &mut R) -> io::Result<Self> {
        let hypothesis = crate::vision_msgs::ObjectHypothesis::decode_one(buf)?;
        let pose = crate::geometry_msgs::PoseWithCovariance::decode_one(buf)?;
        Ok(Self {
            hypothesis,
            pose,
        })
    ...
    pub fn encoded_size(&self) -> usize {
        let mut size = 0usize;
        size += self.hypothesis.encoded_size();
