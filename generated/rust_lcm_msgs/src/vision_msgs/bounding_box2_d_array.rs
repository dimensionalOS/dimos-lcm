...
pub struct BoundingBox2DArray {
    ...
    pub boxes: Vec<crate::vision_msgs::BoundingBox2D>,
}

impl BoundingBox2DArray {
    pub const HASH: i64 = 0xB279B6AC710340A2u64 as i64;
    pub const NAME: &str = "vision_msgs.BoundingBox2DArray";
    ...
    pub fn encode_one<W: Write>(&self, buf: &mut W) {
        buf.write_i32::<BigEndian>(self.boxes.len() as i32).unwrap();
    ...
    pub fn decode_one<R: Read>(buf: &mut R) -> io::Result<Self> {
        ...
        let boxes = {
            ...
            for _ in 0..boxes_length {
                let _elem_0 = crate::vision_msgs::BoundingBox2D::decode_one(buf)?;
                v.push(_elem_0);
            }
            v
        };
