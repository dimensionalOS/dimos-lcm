...
impl ResourceDescription {
    pub const HASH: i64 = 0x802E2D1F1CD1DF73u64 as i64;
    pub const NAME: &str = "dimos_control_msgs.ResourceDescription";

    pub const JOINT: i8 = 1;
    pub const GRIPPER: i8 = 2;
    pub const BASE: i8 = 3;
    pub const IMU: i8 = 4;
    ...
    pub fn encode_one<W: Write>(&self, buf: &mut W) -> io::Result<()> {
        ...
        buf.write_i8(self.resource_type)?;
        {
            let bytes = self.group_name.as_bytes();
            buf.write_u32::<BigEndian>((bytes.len() + 1) as u32)?;
            buf.write_all(bytes)?;
            buf.write_u8(0)?;
        }
