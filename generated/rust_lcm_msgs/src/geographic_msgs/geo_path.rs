...
pub struct GeoPath {
    ...
    pub poses: Vec<crate::geographic_msgs::GeoPoseStamped>,
}

impl GeoPath {
    pub const HASH: i64 = 0xC779B6ACC503055Au64 as i64;
    pub const NAME: &str = "geographic_msgs.GeoPath";
    ...
    pub(crate) fn hash_recursive(parents: &mut Vec<u64>) -> u64 {
        ...
        tmphash = tmphash.wrapping_add(crate::geographic_msgs::GeoPoseStamped::hash_recursive(parents));
        parents.pop();
        // rotate left by 1
    ...
    pub fn decode_one<R: Read>(buf: &mut R) -> io::Result<Self> {
        ...
        let poses = {
            ...
            for _ in 0..poses_length {
                let _elem_0 = crate::geographic_msgs::GeoPoseStamped::decode_one(buf)?;
                v.push(_elem_0);
            }
            v
        };
