...
pub struct BoundingBox {
    pub min_pt: crate::geographic_msgs::GeoPoint,
    pub max_pt: crate::geographic_msgs::GeoPoint,
}

impl BoundingBox {
    pub const HASH: i64 = 0xECB7CBAA66BCCDE0u64 as i64;
    pub const NAME: &str = "geographic_msgs.BoundingBox";
    ...
    pub fn encode_one<W: Write>(&self, buf: &mut W) -> io::Result<()> {
        self.min_pt.encode_one(buf)?;
        self.max_pt.encode_one(buf)?;
        Ok(())
    }

    pub fn decode_one<R: Read>(buf: &mut R) -> io::Result<Self> {
        let min_pt = crate::geographic_msgs::GeoPoint::decode_one(buf)?;
        let max_pt = crate::geographic_msgs::GeoPoint::decode_one(buf)?;
        Ok(Self {
            min_pt,
            max_pt,
        })
    ...
    pub fn encoded_size(&self) -> usize {
        let mut size = 0usize;
        size += self.min_pt.encoded_size();
        size += self.max_pt.encoded_size();
        size
    }
