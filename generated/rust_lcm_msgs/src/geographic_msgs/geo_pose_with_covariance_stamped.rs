...
pub struct GeoPoseWithCovarianceStamped {
    ...
    pub pose: crate::geographic_msgs::GeoPoseWithCovariance,
}

impl GeoPoseWithCovarianceStamped {
    pub const HASH: i64 = 0xE10FEEBEC5C97663u64 as i64;
    pub const NAME: &str = "geographic_msgs.GeoPoseWithCovarianceStamped";
    ...
    pub(crate) fn hash_recursive(parents: &mut Vec<u64>) -> u64 {
        ...
        tmphash = tmphash.wrapping_add(crate::geographic_msgs::GeoPoseWithCovariance::hash_recursive(parents));
        parents.pop();
        // rotate left by 1
    ...
    pub fn decode_one<R: Read>(buf: &mut R) -> io::Result<Self> {
        ...
        let pose = crate::geographic_msgs::GeoPoseWithCovariance::decode_one(buf)?;
        Ok(Self {
            header,
            pose,
        })
