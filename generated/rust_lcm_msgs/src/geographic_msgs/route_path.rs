...
pub struct RoutePath {
    ...
    pub network: crate::uuid_msgs::UniqueID,
    pub segments: Vec<crate::uuid_msgs::UniqueID>,
    pub props: Vec<crate::geographic_msgs::KeyValue>,
}

impl RoutePath {
    pub const HASH: i64 = 0x2F0BAB3ED05E12C3u64 as i64;
    pub const NAME: &str = "geographic_msgs.RoutePath";
    ...
    pub fn decode_one<R: Read>(buf: &mut R) -> io::Result<Self> {
        ...
        let network = crate::uuid_msgs::UniqueID::decode_one(buf)?;
        let segments = {
    ...
    pub fn encoded_size(&self) -> usize {
        ...
        size += self.network.encoded_size();
        for v0 in self.segments.iter() {
