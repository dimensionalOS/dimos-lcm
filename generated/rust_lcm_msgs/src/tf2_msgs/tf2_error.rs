...
impl TF2Error {
    pub const HASH: i64 = 0x1E8FF0D80D02EE55u64 as i64;
    pub const NAME: &str = "tf2_msgs.TF2Error";

    pub const NO_ERROR: i8 = 0;
    pub const LOOKUP_ERROR: i8 = 1;
    pub const CONNECTIVITY_ERROR: i8 = 2;
    pub const EXTRAPOLATION_ERROR: i8 = 3;
    pub const INVALID_ARGUMENT_ERROR: i8 = 4;
    pub const TIMEOUT_ERROR: i8 = 5;
    pub const TRANSFORM_ERROR: i8 = 6;
    ...
    pub fn encode_one<W: Write>(&self, buf: &mut W) {
        buf.write_u8(self.error).unwrap();
        {
            let bytes = self.error_string.as_bytes();
    ...
    pub fn encoded_size(&self) -> usize {
        let mut size = 0usize;
        size += 1;
        size += 4 + self.error_string.len() + 1;
        size
    }
