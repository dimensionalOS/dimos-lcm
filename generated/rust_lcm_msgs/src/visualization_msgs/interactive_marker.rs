...
impl InteractiveMarker {
    ...
    pub(crate) fn hash_recursive(parents: &mut Vec<u64>) -> u64 {
        ...
        tmphash = tmphash.wrapping_add(crate::visualization_msgs::MenuEntry::hash_recursive(parents));
        tmphash = tmphash.wrapping_add(crate::visualization_msgs::InteractiveMarkerControl::hash_recursive(parents));
        parents.pop();
        // rotate left by 1
    ...
    pub fn encode_one<W: Write>(&self, buf: &mut W) {
        buf.write_i32::<BigEndian>(self.menu_entries.len() as i32).unwrap();
        buf.write_i32::<BigEndian>(self.controls.len() as i32).unwrap();
