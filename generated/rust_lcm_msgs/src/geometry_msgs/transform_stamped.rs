...
impl TransformStamped {
    pub const HASH: i64 = 0xF694F4A6D8779002u64 as i64;
    pub const NAME: &str = "geometry_msgs.TransformStamped";
    ...
    pub fn decode_one<R: Read>(buf: &mut R) -> io::Result<Self> {
        ...
        let transform = crate::geometry_msgs::Transform::decode_one(buf)?;
        Ok(Self {
            header,
            child_frame_id,
            transform,
    ...
    pub fn encoded_size(&self) -> usize {
        ...
        size += self.transform.encoded_size();
        size
    }
