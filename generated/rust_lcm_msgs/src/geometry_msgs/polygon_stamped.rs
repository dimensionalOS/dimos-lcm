...
pub struct PolygonStamped {
    ...
    pub polygon: crate::geometry_msgs::Polygon,
}

impl PolygonStamped {
    pub const HASH: i64 = 0x413A2F753630B1D7u64 as i64;
    pub const NAME: &str = "geometry_msgs.PolygonStamped";
    ...
    pub(crate) fn hash_recursive(parents: &mut Vec<u64>) -> u64 {
        ...
        tmphash = tmphash.wrapping_add(crate::geometry_msgs::Polygon::hash_recursive(parents));
        parents.pop();
        // rotate left by 1
    ...
    pub fn encoded_size(&self) -> usize {
        ...
        size += self.polygon.encoded_size();
        size
    }
