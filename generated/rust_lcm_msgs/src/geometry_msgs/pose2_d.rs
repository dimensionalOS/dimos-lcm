...
impl Pose2D {
    pub const HASH: i64 = 0x7491C1074C104593u64 as i64;
    pub const NAME: &str = "geometry_msgs.Pose2D";
    ...
    pub fn encode_one<W: Write>(&self, buf: &mut W) {
        buf.write_f64::<BigEndian>(self.x).unwrap();
        buf.write_f64::<BigEndian>(self.y).unwrap();
        buf.write_f64::<BigEndian>(self.theta).unwrap();
    }
