...
pub struct Wrench {
    pub force: crate::geometry_msgs::Vector3,
    pub torque: crate::geometry_msgs::Vector3,
}

impl Wrench {
    pub const HASH: i64 = 0x0980C3AEA984C9A6u64 as i64;
    pub const NAME: &str = "geometry_msgs.Wrench";
    ...
    pub fn encode_one<W: Write>(&self, buf: &mut W) {
        self.force.encode_one(buf);
        self.torque.encode_one(buf);
    }

    pub fn decode_one<R: Read>(buf: &mut R) -> io::Result<Self> {
        let force = crate::geometry_msgs::Vector3::decode_one(buf)?;
        let torque = crate::geometry_msgs::Vector3::decode_one(buf)?;
        Ok(Self {
            force,
            torque,
        })
    ...
    pub fn encoded_size(&self) -> usize {
        let mut size = 0usize;
        size += self.force.encoded_size();
        size += self.torque.encoded_size();
        size
    }
