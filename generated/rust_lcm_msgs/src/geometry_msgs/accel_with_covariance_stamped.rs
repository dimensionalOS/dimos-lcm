...
pub struct AccelWithCovarianceStamped {
    ...
    pub accel: crate::geometry_msgs::AccelWithCovariance,
}

impl AccelWithCovarianceStamped {
    pub const HASH: i64 = 0xF012322E268930C2u64 as i64;
    pub const NAME: &str = "geometry_msgs.AccelWithCovarianceStamped";
    ...
    pub(crate) fn hash_recursive(parents: &mut Vec<u64>) -> u64 {
        ...
        tmphash = tmphash.wrapping_add(crate::geometry_msgs::AccelWithCovariance::hash_recursive(parents));
        parents.pop();
        // rotate left by 1
    ...
    pub fn decode_one<R: Read>(buf: &mut R) -> io::Result<Self> {
        ...
        let accel = crate::geometry_msgs::AccelWithCovariance::decode_one(buf)?;
        Ok(Self {
            header,
            accel,
        })
