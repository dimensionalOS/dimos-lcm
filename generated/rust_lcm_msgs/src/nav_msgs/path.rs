...
pub struct Path {
    ...
    pub poses: Vec<crate::geometry_msgs::PoseStamped>,
}

impl Path {
    pub const HASH: i64 = 0xC779B6ACC503055Au64 as i64;
    pub const NAME: &str = "nav_msgs.Path";
    ...
    pub(crate) fn hash_recursive(parents: &mut Vec<u64>) -> u64 {
        ...
        tmphash = tmphash.wrapping_add(crate::geometry_msgs::PoseStamped::hash_recursive(parents));
        parents.pop();
        // rotate left by 1
    ...
    pub fn decode_one<R: Read>(buf: &mut R) -> io::Result<Self> {
        ...
        let poses = {
            ...
            for _ in 0..poses_length {
                let _elem_0 = crate::geometry_msgs::PoseStamped::decode_one(buf)?;
                v.push(_elem_0);
            }
            v
        };
