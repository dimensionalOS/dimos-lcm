...
pub struct Odometry {
    ...
    pub twist: crate::geometry_msgs::TwistWithCovariance,
}

impl Odometry {
    pub const HASH: i64 = 0x97F82279756D9D18u64 as i64;
    pub const NAME: &str = "nav_msgs.Odometry";
    ...
    pub(crate) fn hash_recursive(parents: &mut Vec<u64>) -> u64 {
        ...
        tmphash = tmphash.wrapping_add(crate::geometry_msgs::TwistWithCovariance::hash_recursive(parents));
        parents.pop();
        // rotate left by 1
    ...
    pub fn decode_one<R: Read>(buf: &mut R) -> io::Result<Self> {
        ...
        let twist = crate::geometry_msgs::TwistWithCovariance::decode_one(buf)?;
        Ok(Self {
            header,
            child_frame_id,
            pose,
