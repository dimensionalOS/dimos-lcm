...
pub struct OccupancyGrid {
    ...
    pub info: crate::nav_msgs::MapMetaData,
    pub data: Vec<i8>,
}

impl OccupancyGrid {
    pub const HASH: i64 = 0x9E67F3F149308D87u64 as i64;
    pub const NAME: &str = "nav_msgs.OccupancyGrid";
    ...
    pub(crate) fn hash_recursive(parents: &mut Vec<u64>) -> u64 {
        ...
        tmphash = tmphash.wrapping_add(crate::nav_msgs::MapMetaData::hash_recursive(parents));
        parents.pop();
        // rotate left by 1
    ...
    pub fn encode_one<W: Write>(&self, buf: &mut W) {
        ...
        self.info.encode_one(buf);
        for v0 in self.data.iter() {
            buf.write_i8(*v0).unwrap();
        }
    }
    ...
    pub fn decode_one<R: Read>(buf: &mut R) -> io::Result<Self> {
        ...
        let info = crate::nav_msgs::MapMetaData::decode_one(buf)?;
        let data = {
            let mut v = Vec::with_capacity(data_length);
            for _ in 0..data_length {
                let _elem_0 = buf.read_i8()?;
                v.push(_elem_0);
            }
            v
        };
