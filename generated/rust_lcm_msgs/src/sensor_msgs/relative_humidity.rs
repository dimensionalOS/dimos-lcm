...
impl RelativeHumidity {
    pub const HASH: i64 = 0x1DB00395F858F771u64 as i64;
    pub const NAME: &str = "sensor_msgs.RelativeHumidity";
    ...
    pub fn encode_one<W: Write>(&self, buf: &mut W) {
        ...
        buf.write_f64::<BigEndian>(self.relative_humidity).unwrap();
    ...
    pub fn decode_one<R: Read>(buf: &mut R) -> io::Result<Self> {
        ...
        let relative_humidity = buf.read_f64::<BigEndian>()?;
