...
impl PointField {
    pub const HASH: i64 = 0x702E0E03F04285D7u64 as i64;
    pub const NAME: &str = "sensor_msgs.PointField";

    pub const INT8: i8 = 1;
    pub const UINT8: i8 = 2;
    pub const INT16: i8 = 3;
    pub const UINT16: i8 = 4;
    pub const INT32: i8 = 5;
    pub const UINT32: i8 = 6;
    ...
    pub fn encode_one<W: Write>(&self, buf: &mut W) {
        ...
        buf.write_i32::<BigEndian>(self.offset).unwrap();
        buf.write_u8(self.datatype).unwrap();
        buf.write_i32::<BigEndian>(self.count).unwrap();
    }
