...
impl MagneticField {
    pub const HASH: i64 = 0xBFEB021E4751ED88u64 as i64;
    pub const NAME: &str = "sensor_msgs.MagneticField";
    ...
    pub fn decode_one<R: Read>(buf: &mut R) -> io::Result<Self> {
        ...
        let magnetic_field = crate::geometry_msgs::Vector3::decode_one(buf)?;
        let magnetic_field_covariance = {
    ...
    pub fn encoded_size(&self) -> usize {
        ...
        size += self.magnetic_field.encoded_size();
        size += self.magnetic_field_covariance.len() * 8;
        size
    }
