...
impl FluidPressure {
    pub const HASH: i64 = 0x36B91AF6B8F9D388u64 as i64;
    pub const NAME: &str = "sensor_msgs.FluidPressure";
    ...
    pub fn encode_one<W: Write>(&self, buf: &mut W) {
        ...
        buf.write_f64::<BigEndian>(self.fluid_pressure).unwrap();
    ...
    pub fn decode_one<R: Read>(buf: &mut R) -> io::Result<Self> {
        ...
        let fluid_pressure = buf.read_f64::<BigEndian>()?;
