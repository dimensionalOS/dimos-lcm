...
pub struct MultiDOFJointTrajectory {
    ...
    pub points: Vec<crate::trajectory_msgs::MultiDOFJointTrajectoryPoint>,
}

impl MultiDOFJointTrajectory {
    pub const HASH: i64 = 0xF09DB31AFE774086u64 as i64;
    pub const NAME: &str = "trajectory_msgs.MultiDOFJointTrajectory";
    ...
    pub(crate) fn hash_recursive(parents: &mut Vec<u64>) -> u64 {
        ...
        tmphash = tmphash.wrapping_add(crate::trajectory_msgs::MultiDOFJointTrajectoryPoint::hash_recursive(parents));
        parents.pop();
        // rotate left by 1
    ...
    pub fn encode_one<W: Write>(&self, buf: &mut W) {
        buf.write_i32::<BigEndian>(self.joint_names.len() as i32).unwrap();
    ...
    pub fn decode_one<R: Read>(buf: &mut R) -> io::Result<Self> {
        ...
        let points = {
            ...
            for _ in 0..points_length {
                let _elem_0 = crate::trajectory_msgs::MultiDOFJointTrajectoryPoint::decode_one(buf)?;
                v.push(_elem_0);
            }
            v
        };
