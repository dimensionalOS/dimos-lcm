...
pub struct PosesInFrame {
    ...
    pub poses: Vec<crate::geometry_msgs::Pose>,
}

impl PosesInFrame {
    pub const HASH: i64 = 0x65F6CEE7D8076F4Bu64 as i64;
    pub const NAME: &str = "foxglove_msgs.PosesInFrame";
    ...
    pub fn decode_one<R: Read>(buf: &mut R) -> io::Result<Self> {
        ...
        let poses = {
            ...
            for _ in 0..poses_length {
                let _elem_0 = crate::geometry_msgs::Pose::decode_one(buf)?;
                v.push(_elem_0);
            }
            v
        };
