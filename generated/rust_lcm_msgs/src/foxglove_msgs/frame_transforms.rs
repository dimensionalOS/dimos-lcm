...
pub struct FrameTransforms {
    pub transforms: Vec<crate::foxglove_msgs::FrameTransform>,
}

impl FrameTransforms {
    pub const HASH: i64 = 0x37BC5CBCE50A5CE2u64 as i64;
    pub const NAME: &str = "foxglove_msgs.FrameTransforms";
    ...
    pub(crate) fn hash_recursive(parents: &mut Vec<u64>) -> u64 {
        ...
        tmphash = tmphash.wrapping_add(crate::foxglove_msgs::FrameTransform::hash_recursive(parents));
        parents.pop();
        // rotate left by 1
    ...
    pub fn decode_one<R: Read>(buf: &mut R) -> io::Result<Self> {
        ...
        let transforms = {
            ...
            for _ in 0..transforms_length {
                let _elem_0 = crate::foxglove_msgs::FrameTransform::decode_one(buf)?;
                v.push(_elem_0);
            }
            v
        };
