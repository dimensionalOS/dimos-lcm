...
impl UInt32 {
    pub const HASH: i64 = 0x165E7CFBF548811Fu64 as i64;
    pub const NAME: &str = "std_msgs.UInt32";
    ...
    pub fn encode_one<W: Write>(&self, buf: &mut W) {
        buf.write_i32::<BigEndian>(self.data).unwrap();
    }

    pub fn decode_one<R: Read>(buf: &mut R) -> io::Result<Self> {
        let data = buf.read_i32::<BigEndian>()?;
        Ok(Self {
            data,
        })
    }
