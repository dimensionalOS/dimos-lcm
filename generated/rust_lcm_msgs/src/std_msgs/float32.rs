...
impl Float32 {
    pub const HASH: i64 = 0x856E135C782A36E9u64 as i64;
    pub const NAME: &str = "std_msgs.Float32";
    ...
    pub fn encode_one<W: Write>(&self, buf: &mut W) {
        buf.write_f32::<BigEndian>(self.data).unwrap();
    }

    pub fn decode_one<R: Read>(buf: &mut R) -> io::Result<Self> {
        let data = buf.read_f32::<BigEndian>()?;
        Ok(Self {
            data,
        })
    }
