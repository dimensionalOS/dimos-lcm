...
impl Float64 {
    pub const HASH: i64 = 0x90EEA081D4D0B10Au64 as i64;
    pub const NAME: &str = "std_msgs.Float64";
    ...
    pub fn encode_one<W: Write>(&self, buf: &mut W) {
        buf.write_f64::<BigEndian>(self.data).unwrap();
    }

    pub fn decode_one<R: Read>(buf: &mut R) -> io::Result<Self> {
        let data = buf.read_f64::<BigEndian>()?;
        Ok(Self {
            data,
        })
    }
