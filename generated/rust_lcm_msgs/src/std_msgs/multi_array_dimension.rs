...
impl MultiArrayDimension {
    pub const HASH: i64 = 0xCEC1B9E9D868EF97u64 as i64;
    pub const NAME: &str = "std_msgs.MultiArrayDimension";
    ...
    pub fn encode_one<W: Write>(&self, buf: &mut W) -> io::Result<()> {
        ...
        buf.write_i32::<BigEndian>(self.size)?;
        buf.write_i32::<BigEndian>(self.stride)?;
        Ok(())
    }
    ...
    pub fn decode_one<R: Read>(buf: &mut R) -> io::Result<Self> {
        ...
        let stride = buf.read_i32::<BigEndian>()?;
        Ok(Self {
            label,
            size,
            stride,
