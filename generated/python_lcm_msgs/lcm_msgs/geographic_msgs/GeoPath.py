...
from . import *
from .GeoPoseStamped import GeoPoseStamped


class GeoPath(object):
    msg_name = "geographic_msgs.GeoPath"

    __slots__ = ["poses_length", "header", "poses"]

    __typenames__ = ["int32_t", "std_msgs.Header", "GeoPoseStamped"]
    ...
    def __init__(self, poses_length=0, header=std_msgs.Header(), poses=[]):
        ...
        self.header = header
        # LCM Type: GeoPoseStamped[poses_length]
        self.poses = poses

    def lcm_encode(self):
        buf = BytesIO()
        buf.write(GeoPath._get_packed_fingerprint())
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(self.poses_length):
            assert (
                ...
                == GeoPoseStamped._get_packed_fingerprint()
            )
    ...
    def _get_hash_recursive(cls, parents):
        ...
        tmphash = (
            ...
            + GeoPoseStamped._get_hash_recursive(newparents)
        ) & 0xFFFFFFFFFFFFFFFF
        tmphash = (
