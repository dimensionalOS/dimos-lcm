...
class GeoPointStamped(object):
    msg_name = "GeoPointStamped"

    __slots__ = ["header", "position"]

    __typenames__ = ["std_msgs.Header", "GeoPoint"]
    ...
    def __init__(self, header=std_msgs.Header(), position=GeoPoint()):
    ...
    def lcm_encode(self):
        buf = BytesIO()
        buf.write(GeoPointStamped._get_packed_fingerprint())
