...
static inline int dimos_msg__PoseWithCovariance__encode(void *buf, int offset, int maxlen,
    const dimos_msg__PoseWithCovariance *p)
{
    int pos = 0, thislen;
...
static inline int dimos_msg__PoseWithCovariance__decode(const void *buf, int offset,
    int maxlen, dimos_msg__PoseWithCovariance *p)
{
    int pos = 0, thislen;
