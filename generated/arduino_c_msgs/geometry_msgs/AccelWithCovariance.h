...
static inline int dimos_msg__AccelWithCovariance__encode(void *buf, int offset, int maxlen,
    const dimos_msg__AccelWithCovariance *p)
{
    int pos = 0, thislen;
...
static inline int dimos_msg__AccelWithCovariance__decode(const void *buf, int offset,
    int maxlen, dimos_msg__AccelWithCovariance *p)
{
    int pos = 0, thislen;
