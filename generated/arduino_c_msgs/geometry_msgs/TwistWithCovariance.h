...
static inline int dimos_msg__TwistWithCovariance__encode(void *buf, int offset, int maxlen,
    const dimos_msg__TwistWithCovariance *p)
{
    int pos = 0, thislen;
...
static inline int dimos_msg__TwistWithCovariance__decode(const void *buf, int offset,
    int maxlen, dimos_msg__TwistWithCovariance *p)
{
    int pos = 0, thislen;
