...
public final class JointTrajectory implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(trajectory_msgs.JointTrajectory.class))
            return 0L;
 
        classes.add(trajectory_msgs.JointTrajectory.class);
    ...
    public JointTrajectory(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public JointTrajectory(DataInput ins) throws IOException
    {
    ...
    public static trajectory_msgs.JointTrajectory _decodeRecursiveFactory(DataInput ins) throws IOException
    {
