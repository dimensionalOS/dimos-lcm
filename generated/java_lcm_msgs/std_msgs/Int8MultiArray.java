...
public final class Int8MultiArray implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(std_msgs.Int8MultiArray.class))
            return 0L;
 
        classes.add(std_msgs.Int8MultiArray.class);
    ...
    public Int8MultiArray(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public Int8MultiArray(DataInput ins) throws IOException
    {
    ...
    public static std_msgs.Int8MultiArray _decodeRecursiveFactory(DataInput ins) throws IOException
    {
