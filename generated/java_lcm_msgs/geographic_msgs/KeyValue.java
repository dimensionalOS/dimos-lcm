...
public final class KeyValue implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(geographic_msgs.KeyValue.class))
            return 0L;
 
        classes.add(geographic_msgs.KeyValue.class);
    ...
    public static geographic_msgs.KeyValue _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        geographic_msgs.KeyValue o = new geographic_msgs.KeyValue();
    ...
    public geographic_msgs.KeyValue copy()
    {
        geographic_msgs.KeyValue outobj = new geographic_msgs.KeyValue();
        outobj.key = this.key;
