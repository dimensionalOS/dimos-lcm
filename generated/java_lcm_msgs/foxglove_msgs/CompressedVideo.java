...
public final class CompressedVideo implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(foxglove_msgs.CompressedVideo.class))
            return 0L;
 
        classes.add(foxglove_msgs.CompressedVideo.class);
    ...
    public CompressedVideo(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public CompressedVideo(DataInput ins) throws IOException
    {
    ...
    public static foxglove_msgs.CompressedVideo _decodeRecursiveFactory(DataInput ins) throws IOException
    {
