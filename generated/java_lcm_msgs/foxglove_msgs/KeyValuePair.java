...
public final class KeyValuePair implements lcm.lcm.LCMEncodable
{
    public String key;
    ...
    {
        if (classes.contains(foxglove_msgs.KeyValuePair.class))
            return 0L;
 
        classes.add(foxglove_msgs.KeyValuePair.class);
    ...
    public KeyValuePair(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public KeyValuePair(DataInput ins) throws IOException
    {
    ...
    public static foxglove_msgs.KeyValuePair _decodeRecursiveFactory(DataInput ins) throws IOException
    {
