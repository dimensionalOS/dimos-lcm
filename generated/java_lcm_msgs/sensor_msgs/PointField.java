...
public final class PointField implements lcm.lcm.LCMEncodable
{
    public String name;
    ...
    public static final long LCM_FINGERPRINT_BASE = 0x702e0e03f04285d7L;
    ...
    {
        if (classes.contains(sensor_msgs.PointField.class))
            return 0L;
 
        classes.add(sensor_msgs.PointField.class);
    ...
    public PointField(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public PointField(DataInput ins) throws IOException
    {
    ...
    public static sensor_msgs.PointField _decodeRecursiveFactory(DataInput ins) throws IOException
    {
