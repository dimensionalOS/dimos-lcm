// Standalone package entrypoint; maintained alongside tools/ts/msgs/mod.ts.
...
import * as control_msgs from "./control_msgs/mod.ts";
import * as foxglove_msgs from "./foxglove_msgs/mod.ts";
import * as geographic_msgs from "./geographic_msgs/mod.ts";
...
import * as uuid_msgs from "./uuid_msgs/mod.ts";
...
export * as control_msgs from "./control_msgs/mod.ts";
export * as foxglove_msgs from "./foxglove_msgs/mod.ts";
export * as geographic_msgs from "./geographic_msgs/mod.ts";
...
export * as uuid_msgs from "./uuid_msgs/mod.ts";
...
const _registry = { registerPackage: _registerPackage };
  ...
  _registry.registerPackage(control_msgs);
  _registry.registerPackage(foxglove_msgs);
  _registry.registerPackage(geographic_msgs);
  ...
  _registry.registerPackage(uuid_msgs);
