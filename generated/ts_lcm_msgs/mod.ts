...
import * as dimos_control_msgs from "./dimos_control_msgs/mod.ts";
...
export * as dimos_control_msgs from "./dimos_control_msgs/mod.ts";
...
const _registry = { registerPackage: _registerPackage };
  ...
  _registry.registerPackage(dimos_control_msgs);
