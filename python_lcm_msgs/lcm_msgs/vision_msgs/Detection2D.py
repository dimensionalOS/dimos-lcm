...
class Detection2D(object):
    ...
    __typenames__ = ["int32_t", "std_msgs.Header", "vision_msgs.ObjectHypothesisWithPose", "vision_msgs.BoundingBox2D", "string"]

    __dimensions__ = [None, None, ["results_length"], None, None]

    def __init__(self, results_length=0, header=std_msgs.Header(), results=[], bbox=vision_msgs.BoundingBox2D(), id=""):
        # LCM Type: int32_t
        ...
        # LCM Type: vision_msgs.BoundingBox2D
        self.bbox = bbox
        # LCM Type: string
        self.id = id
    ...
    def _encode_one(self, buf):
        ...
        assert self.bbox._get_packed_fingerprint() == vision_msgs.BoundingBox2D._get_packed_fingerprint()
    ...
    def _decode_one(cls, buf):
        ...
        self.bbox = vision_msgs.BoundingBox2D._decode_one(buf)
    ...
    def _get_hash_recursive(cls, parents):
        ...
        tmphash = (0x7c62020c10a78d22+ std_msgs.Header._get_hash_recursive(newparents)+ vision_msgs.ObjectHypothesisWithPose._get_hash_recursive(newparents)+ vision_msgs.BoundingBox2D._get_hash_recursive(newparents)) & 0xffffffffffffffff
