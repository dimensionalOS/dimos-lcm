...
class Int64MultiArray(object):
    ...
    __typenames__ = ["int32_t", "std_msgs.MultiArrayLayout", "int64_t"]
    ...
    def _get_hash_recursive(cls, parents):
        ...
        tmphash = (0xaa51366c8f22187e+ std_msgs.MultiArrayLayout._get_hash_recursive(newparents)) & 0xffffffffffffffff
