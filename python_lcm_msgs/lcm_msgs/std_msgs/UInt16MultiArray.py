...
class UInt16MultiArray(object):
    ...
    msg_name = "std_msgs.UInt16MultiArray"

    __slots__ = ["data_length", "layout", "data"]

    __typenames__ = ["int32_t", "std_msgs.MultiArrayLayout", "int16_t"]
    ...
    def _get_hash_recursive(cls, parents):
        ...
        tmphash = (0xaa51366c8f222c76+ std_msgs.MultiArrayLayout._get_hash_recursive(newparents)) & 0xffffffffffffffff
