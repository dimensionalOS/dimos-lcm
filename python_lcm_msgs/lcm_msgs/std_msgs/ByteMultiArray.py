...
class ByteMultiArray(object):
    ...
    __typenames__ = ["int32_t", "std_msgs.MultiArrayLayout", "int8_t"]
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(ByteMultiArray._get_packed_fingerprint())
    ...
    def _get_hash_recursive(cls, parents):
        ...
        tmphash = (0xdcc1940b891be505+ std_msgs.MultiArrayLayout._get_hash_recursive(newparents)) & 0xffffffffffffffff
