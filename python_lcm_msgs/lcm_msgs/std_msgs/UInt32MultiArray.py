...
class UInt32MultiArray(object):

    msg_name = "std_msgs.UInt32MultiArray"

    __slots__ = ["data_length", "layout", "data"]

    __typenames__ = ["int32_t", "std_msgs.MultiArrayLayout", "int32_t"]
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(UInt32MultiArray._get_packed_fingerprint())
    ...
    def _get_hash_recursive(cls, parents):
        ...
        tmphash = (0xaa51366c8f222486+ std_msgs.MultiArrayLayout._get_hash_recursive(newparents)) & 0xffffffffffffffff
