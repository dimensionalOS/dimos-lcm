...
class SpherePrimitive(object):
    ...
    __typenames__ = ["geometry_msgs.Pose", "geometry_msgs.Vector3", "foxglove_msgs.Color"]

    __dimensions__ = [None, None, None]

    def __init__(self, pose=geometry_msgs.Pose(), size=geometry_msgs.Vector3(), color=foxglove_msgs.Color()):
    ...
    def _get_hash_recursive(cls, parents):
        ...
        tmphash = (0xe7e8912ea6542887+ geometry_msgs.Pose._get_hash_recursive(newparents)+ geometry_msgs.Vector3._get_hash_recursive(newparents)+ foxglove_msgs.Color._get_hash_recursive(newparents)) & 0xffffffffffffffff
