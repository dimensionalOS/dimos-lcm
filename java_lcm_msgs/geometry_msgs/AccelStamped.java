...
public final class AccelStamped implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(geometry_msgs.AccelStamped.class))
            return 0L;
 
        classes.add(geometry_msgs.AccelStamped.class);
    ...
    public AccelStamped(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public AccelStamped(DataInput ins) throws IOException
    {
    ...
    public static geometry_msgs.AccelStamped _decodeRecursiveFactory(DataInput ins) throws IOException
    {
