...
public final class PointCloud implements lcm.lcm.LCMEncodable
{
    ...
    public static final long LCM_FINGERPRINT_BASE = 0x4f3713aa9b8dc878L;
    ...
    {
        if (classes.contains(foxglove_msgs.PointCloud.class))
            return 0L;
 
        classes.add(foxglove_msgs.PointCloud.class);
    ...
    public void _encodeRecursive(DataOutput outs) throws IOException
    {
        ...
        outs.writeInt(this.point_stride); 
    ...
    public static foxglove_msgs.PointCloud _decodeRecursiveFactory(DataInput ins) throws IOException
    {
